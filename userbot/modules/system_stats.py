...
async def amireallyalive(alive):
    ...
    output = (
        f"**[Gojo-Userbot](https://github.com/Cloder07/Gojo-Userbot) Telah Di Aktifkan.**\n\n"
        ...
        f"└ **⏳BotUptime :** `{uptime}` \n\n"
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/{GROUP})** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/{CHANNEL})** | **[𝗢𝘄𝗻𝗲𝗿](https://t.me/Gojo_satoru44)**"
    )
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
