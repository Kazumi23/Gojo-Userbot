...
@bot.on(poci_cmd(outgoing=True, pattern=r"dice(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(poci_cmd(outgoing=True, pattern=r"dart(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@bot.on(poci_cmd(outgoing=True, pattern=r"basket(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@bot.on(poci_cmd(outgoing=True, pattern=r"bowling(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@bot.on(poci_cmd(outgoing=True, pattern=r"ball(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
...
@bot.on(poci_cmd(outgoing=True, pattern=r"jackpot(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    input_str = event.pattern_match.group(1)
