...
from userbot.utils import bash, deEmojify, poci_cmd
...
CMD_HELP.update(
    {
        ...
        \n  •  **Example  : **{cmd}tweet @gojosatoru (harus pake . [titik])\
    "
    }
)
